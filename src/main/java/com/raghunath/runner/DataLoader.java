...
//code will be execute only once when application is started;
	...
	public void run(ApplicationArguments args) throws Exception {
		...
		//cash plan data<Terminate>
				...
				c3.setBenefitAmt(5000.80);
				c3.setTerminatedDate(LocalDate.now());
				c3.setTerminationRsn("Job");
				...
				//cash plan data<Terminate>
						...
						//cash plan data<Terminate>
								...
								//Employment plan data<Terminate>
